...
INSERT INTO users(gamma_id, group_id)
VALUES ('b69e01cd-01d1-465e-adc5-99d017b7fd74', 1);
-- Cal
...
INSERT INTO users(gamma_id, group_id)
VALUES ('ec202592-50b2-471c-96c6-893493cf724e', 2);
-- Fredag
...
VALUES (1, 'Pripps', 'https://product-cdn.systembolaget.se/productimages/507795/507795_400.png');
INSERT INTO prices(item_id, price, display_name)
VALUES (3, 10, 'P.R.I.T.');
INSERT INTO prices(item_id, price, display_name)
VALUES (3, 12, 'Pateter');
...
INSERT INTO purchased_items
(transaction_id, item_id, display_name, purchase_price, purchase_price_name, quantity)
VALUES (2, 3, 'Pripps', 10, 'P.R.I.T.', 3);
INSERT INTO purchased_items
(transaction_id, item_id, display_name, purchase_price, purchase_price_name, quantity)
